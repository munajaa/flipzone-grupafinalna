      ...
      <main className="max-w-7xl mx-auto px-6 md:px-10 pb-20">
        {activeSection === 'dashboard' && (
          <div className="py-20 text-center space-y-12 animate-in fade-in duration-1000">
            <h1 className="text-5xl md:text-8xl font-black font-heading italic leading-tight tracking-tighter text-white">ELITNI <span className="animate-text-gradient uppercase">PRISTUP</span></h1>
            <p className="text-base md:text-lg text-slate-400 max-w-2xl mx-auto font-medium italic">Dobrodošli u komandni centar. Svi resursi su otključani.</p>
